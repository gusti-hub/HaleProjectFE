                        ...
                        <div className="w-full flex flex-col items-center gap-4">
                            <div className="w-full flex items-start justify-start gap-4">
                                <div className='min-w-[12rem] w-full flex flex-col items-start gap-2 p-3 rounded-md bg-[#F8F9FD] border border-solid border-gray-300'>
                                    <div className='font-medium flex justify-center w-full'>Items in Design</div>
                                    <div className='font-semibold text-3xl flex justify-center w-full'>{3}</div>
                                </div>
                                <div className='min-w-[12rem] w-full flex flex-col items-start gap-2 p-3 rounded-md bg-[#F8F9FD] border border-solid border-gray-300'>
                                    <div className='font-medium flex justify-center w-full'>Items Approved</div>
                                    <div className='font-semibold text-3xl flex justify-center w-full'>{2}</div>
                                </div>
                            </div>
                            <div className="w-full flex items-start justify-start gap-4">
                                <div className='min-w-[12rem] w-full flex flex-col items-start gap-2 p-3 rounded-md bg-[#F8F9FD] border border-solid border-gray-300'>
                                    <div className='font-medium flex justify-center w-full'>Items To Be Selected</div>
                                    <div className='font-semibold text-3xl flex justify-center w-full'>{3}</div>
                                </div>
                                <div className='min-w-[12rem] w-full flex flex-col items-start gap-2 p-3 rounded-md bg-[#F8F9FD] border border-solid border-gray-300'>
                                    <div className='font-medium flex justify-center w-full'>Items Sent For RFQ</div>
                                    <div className='font-semibold text-3xl flex justify-center w-full'>{3}</div>
                                </div>
                            </div>
                            <div className="w-full flex items-start justify-start gap-4">
                            <div className='min-w-[12rem] w-full flex flex-col items-start gap-2 p-3 rounded-md bg-[#F8F9FD] border border-solid border-gray-300'>
                                <div className='font-medium flex justify-center w-full'>Items In Proposal</div>
                                <div className='font-semibold text-3xl flex justify-center w-full'>{3}</div>
                            </div>
                            <div className='min-w-[12rem] w-full flex flex-col items-start gap-2 p-3 rounded-md bg-[#F8F9FD] border border-solid border-gray-300'>
                                <div className='font-medium flex justify-center w-full'>Items To Be Added To Proposal</div>
                                <div className='font-semibold text-3xl flex justify-center w-full'>{3}</div>
                            </div>
                        </div>                            
                        </div>
