            ...
            <div className="w-full flex items-start justify-center rounded-lg">
                ...
                <div className={`${isExpanded ? userType === 'Employee' ? "w-[20%]" : "w-[15%]" : "w-[5%]"} flex flex-col items-center justify-between bg-[#F8F9FD] minHeight rounded-l-lg`}>
                    <div className="w-full flex flex-col items-center justify-start px-2">
                        ...
                        {
                            userType === 'Employee' && <div className="w-full flex flex-col items-center justify-start m-6 gap-1">
                                <div
                                    onClick={() => handleMenuID(1)}
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 1 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 2 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 9 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 3 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 4 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 5 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                {/* <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 6 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 7 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 8 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center gap-4 p-3 py-1.5 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'} ${menuID === 10 ? 'bg-[#E9ECF5] rounded-[30px]' : 'bg-transparent'}`}>
                    ...
                    <div className="w-full flex flex-col items-center justify-center">
                        ...
                        <div
                            ...
                            className={`w-full flex items-center justify-start gap-3 p-4 pt-3 cursor-pointer ${isExpanded ? 'justify-start' : 'justify-center'}`}>
